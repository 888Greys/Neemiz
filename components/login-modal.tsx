      ...
      >
        ...
        <div className="px-7 pb-7">
          ...
          <div className="flex justify-center gap-2.5">
            ...
            {/* Telegram */}
            <button type="button" aria-label="Telegram" className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#18191f] text-[#2AABEE] ring-1 ring-white/[0.07] transition hover:bg-[#22252e]">
              <TgIcon />
            </button>
            {/* GitHub */}
            <button
            ...
            {/* Apple */}
            <button type="button" aria-label="Apple" className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#18191f] text-white ring-1 ring-white/[0.07] transition hover:bg-[#22252e]">
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
