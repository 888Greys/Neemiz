    ...
    <AppShell>
      <div className="flex flex-col items-center justify-center px-6 py-24 text-center">
        <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-[#1e2028]">
          <Icon name="swap_horiz" fill className="text-[42px] text-slate-500" />
        </div>
        <h2 className="text-2xl font-black text-white">P2P Trading</h2>
        <p className="mt-3 max-w-sm text-sm leading-6 text-slate-400">
          Buy and sell with real merchants. Escrow-protected every trade.
        </p>
