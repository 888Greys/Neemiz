...
export async function POST(req: Request) {
  ...
  if (!Number.isInteger(amount) || amount < 49 || amount > 150_000) return Response.json({ error: "Amount must be a whole number between KSh 49 and KSh 150,000" }, { status: 400 });
