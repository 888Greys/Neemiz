...
const BREVO_SENDER_NAME = process.env.BREVO_SENDER_NAME ?? "Neemiz";
                  ...
                  <table width="560" cellpadding="0" cellspacing="0" style="background:#171f33;border-radius:12px;border:1px solid #3c4a42;overflow:hidden;">
                    <tr>
                      <td style="background:linear-gradient(135deg,#10b981 0%,#0b1326 60%);padding:40px;text-align:center;">
                        <h1 style="margin:0;font-size:32px;font-weight:900;letter-spacing:-1px;color:#4edea3;">NEEMIZ</h1>
                    ...
                    <tr>
                      <td style="padding:40px;">
                        ...
                        <p style="margin:0 0 24px;color:#bbcabf;line-height:1.6;">
                          You're now part of Neemiz — your all-in-one platform for sports betting, predictions, P2P trading, and more.
                        </p>
                        ...
                        <table cellpadding="0" cellspacing="0" style="margin-bottom:32px;width:100%;">
                          <tr>
                            <td align="center">
                              <a href="${process.env.NEXT_PUBLIC_APP_URL ?? "https://neemiz.com"}/wallet" style="display:inline-block;background:#10b981;color:#003824;font-weight:700;padding:14px 36px;border-radius:8px;text-decoration:none;font-size:15px;">
                    ...
                    <tr>
                      <td style="padding:20px 40px;border-top:1px solid #3c4a42;text-align:center;">
                        <p style="margin:0;color:#86948a;font-size:11px;">© 2025 Neemiz · All rights reserved</p>
                      </td>
                    </tr>
                  </table>
                </td>
